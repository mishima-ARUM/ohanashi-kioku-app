    ...
    questions: [
      {
        ...
        options: [
          { id: 'park',     label: 'こうえん', imageUrl: '/illust/park.svg' },
          { id: 'sea',      label: 'うみ',     imageUrl: '/illust/sea.svg' },
          { id: 'mountain', label: 'やま',     imageUrl: '/illust/mountain.svg' },
          { id: 'station',  label: 'えき',     imageUrl: '/illust/station.svg' },
        ],
      ...
      },
      {
        ...
        options: [
          { id: 'swan',    label: 'はくちょう', imageUrl: '/illust/swan.svg' },
          { id: 'heron',   label: 'しろいサギ', imageUrl: '/illust/heron.svg' },
          { id: 'duck',    label: 'かも',       imageUrl: '/illust/duck.svg' },
          { id: 'sparrow', label: 'すずめ',     imageUrl: '/illust/sparrow.svg' },
        ],
      ...
      },
      {
        ...
        options: [
          { id: 'apple',      label: 'りんごジュース',   imageUrl: '/illust/juice-apple.svg' },
          { id: 'strawberry', label: 'いちごジュース',   imageUrl: '/illust/juice-strawberry.svg' },
          { id: 'orange',     label: 'オレンジジュース', imageUrl: '/illust/juice-orange.svg' },
          { id: 'grape',      label: 'ぶどうジュース',   imageUrl: '/illust/juice-grape.svg' },
        ],
      ...
      },
      {
        ...
        options: [
          { id: 'spring', label: 'はる', imageUrl: '/illust/spring.svg' },
          { id: 'summer', label: 'なつ', imageUrl: '/illust/summer.svg' },
          { id: 'autumn', label: 'あき', imageUrl: '/illust/autumn.svg' },
          { id: 'winter', label: 'ふゆ', imageUrl: '/illust/winter.svg' },
        ],
    ...
    questions: [
      {
        ...
        options: [
          { id: 'red',    label: 'あかいぼうし',   imageUrl: '/illust/hat-red.svg' },
          { id: 'yellow', label: 'きいろいぼうし', imageUrl: '/illust/hat-yellow.svg' },
          { id: 'blue',   label: 'あおいぼうし',   imageUrl: '/illust/hat-blue.svg' },
          { id: 'green',  label: 'みどりのぼうし', imageUrl: '/illust/hat-green.svg' },
        ],
  ...
  // ===== ⭐⭐ ふつう（5問） =====
  {
    ...
    questions: [
      ...
      },
      {
        ...
        options: [
          { id: 'apple',  label: 'りんご',       imageUrl: '/illust/apple.svg' },
          { id: 'banana', label: 'バナナ',       imageUrl: '/illust/banana.svg' },
          { id: 'milk',   label: 'ぎゅうにゅう', imageUrl: '/illust/milk.svg' },
          { id: 'orange', label: 'オレンジ',     imageUrl: '/illust/orange.svg' },
        ],
